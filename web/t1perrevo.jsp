			...
			<center>
                ...
                <table style="width: 100%" border="3">
                            <tr>
                                ...
                                <th style="color:#ffffff;font-size: 15px">Forward Revocation</th>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from filereq where oid='" + oid + "' And status='sent' And status1='GRANTED'");
                                    while (rs.next()) {
                            ...
                            <tr>
                                ...
                                <td style="color: ffffff;font-size: 15px"><%=rs.getString("t2name")%></td>
                                ...
                                <td><a href="t1perrevo1.jsp?t2tenant=<%=rs.getString("t2tenant")%>&fid=<%=rs.getString("fid")%>&filename=<%=rs.getString("filename")%>&oid=<%=rs.getString("oid")%>&uid=<%=rs.getString("t2id")%>&t2mail=<%=rs.getString("t2mail")%>&fskey=<%=rs.getString("fskey")%>"><font style="color: ffffff;font-size: 15px">Forward Revocation</font></a></td>
