        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="crmslog.jsp" onclick="return confirm('Are you sure you want to quit this session?');">Logout</a>
                    </li>
                    <li style="float:right">
                        <a class="page-scroll" href="crmslog.jsp" onclick="return confirm('Are you sure you want to quit this session?');">CRMS</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <header>
       <div class="header-content">
            <div class="header-content-inner"><center>
                <h1 id="homeHeading">CROSS CHECK POLICIES RESULT TO T1</h1>
                <hr>
                        <table style="width: 950px" border="3">
                            <tr>
                                ...
                                <th style="color:#ffffff;font-size: 15px">Status</th>
                                <th style="color:#ffffff;font-size: 15px">Send To T1</th>
                            </tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from filereq where status='Approved'");
                                    while (rs.next()) {
                            ...
                            <tr>
                                ...
                                <td style="color: ffffff;font-size: 15px"><%=rs.getString("status")%></td>
                                <td><a href="crmssendresult1.jsp?t2tenant=<%=rs.getString("t2tenant")%>&fid=<%=rs.getString("fid")%>&oid=<%=rs.getString("oid")%>&filename=<%=rs.getString("filename")%>&t1tenant=<%=rs.getString("otenant")%>&t2id=<%=rs.getString("t2id")%>"><font style="color: ffffff;font-size: 15px">Send</font></a></td>
                            </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
