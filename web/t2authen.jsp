    ...
    <header>
       <div class="header-content">
            <div class="header-content-inner"><center>
                <h1 id="homeHeading">AUTHENTICATE THE IDENTITY</h1>
                <hr>
                        <table style="width: 900px" border="3">
                            <tr>
                                ...
                                <th style="color:#ffffff;font-size: 15px">Authenticate</th>
                            </tr>
                            <%
                                String uid = (String) session.getAttribute("t2id");
                                Connection con = null;
                                Statement st = null;
                                ResultSet rs = null;
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from filereq where t2id='" + uid + "' And status='Redirected'");
                                    while (rs.next()) {
                            ...
                            <tr>
                                ...
                                <td><a href="t2authen1.jsp?t2tenant=<%=rs.getString("t2tenant")%>&fid=<%=rs.getString("fid")%>&oid=<%=rs.getString("oid")%>&filename=<%=rs.getString("filename")%>&t1tenant=<%=rs.getString("otenant")%>&t2id=<%=rs.getString("t2id")%>">
                                        <font style="color: ffffff;font-size: 15px">Authenticate</font></a></td>
