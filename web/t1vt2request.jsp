...
<body id="page-top">
    ...
    <header>
       <div class="header-content">
			...
			<center>
                <h1 id="homeHeading">View File Access Activation Requests</h1>
                <hr>
                 <table style="width: 100%" border="3">
                            <tr>
                                ...
                                <th style="color:#ffffff;font-size: 15px">To CRMS</th>
                            </tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from filereq where oid='" + oid + "' And status='Requested'");
                                    while (rs.next()) {
                            ...
                            <tr>
                                ...
                                <td><a href="forward.jsp?t2tenant=<%=rs.getString("t2tenant")%>&fid=<%=rs.getString("fid")%>&oid=<%=rs.getString("oid")%>&uid=<%=rs.getString("t2id")%>"><font style="color: ffffff;font-size: 15px">Forward</font></a></td>
                            </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
