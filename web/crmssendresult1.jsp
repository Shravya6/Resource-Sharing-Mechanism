<%-- 
    Document   : crmssendresult1
    Created on : Jul 12, 2017, 4:57:23 PM
    Author     : java3
--%>
...
System.out.println("T2 Authentication=="+t2tenant+fid+oid+uid+filename+t1tenant);
 Connection con = null;
    ...
    try {                       
            int i = sto.executeUpdate("update filereq set status='Sent',status1='approved' where fid='" + fid + "' And status='Approved' And oid='"+oid+"' And t2id='"+uid+"'");
           ...
           window.location="crmssendresult.jsp";
           </script>
          <%
