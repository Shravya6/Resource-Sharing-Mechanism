...
<body id="page-top">
    ...
    <header>
       <div class="header-content">
			...
			<center>
                <h1 id="homeHeading">DOWNLOADED FILE HISTORY</h1>
                <hr>
                        <table style="width: 100%" border="3">
                            <tr>
                                ...
                                <th style="color:#ffffff;font-size: 15px"> Time</th>                                
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from download where t2id='"+t2id+"'");
                                    while (rs.next()) {
                            ...
                            <tr>
                                ...
                                <td style="color: ffffff;font-size: 15px"><%=rs.getString("fname")%></td>
