    ...
    String id=request.getParameter("dpid");
      String name = request.getParameter("name");
       ...
       String Country = request.getParameter("country");
            ...
            int is = st.executeUpdate("insert into provider(id,name, pass, email, dob, gen, role, state, country) values ('"+ id +"','" + name + "','" + pass + "','" + Eamil + "','" + dob + "','" + gen + "','" + role + "','" + State + "','" + Country + "')");                                           
                if (is != 0) {
                %>
<script type="text/javascript">
           ...
           window.location="dataproreg.jsp";
           </script>
